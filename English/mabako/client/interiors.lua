...
function recieveServicesInteriorMarkers( x,y,z,marker_type,i,d )
	...
	markers[num].Col = createColTube ( x, y, z-100, 325, z+100 )
...
--	for i,v in ipairs (markers) do
     markers[num].Blip = createBlip( markers[num].X, markers[num].Y, markers[num].Z, markers[num].MType, 1, 255, 255, 255, 255, 0, 330 )
--	end
